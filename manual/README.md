...
- **[Руководство по запуску и использованию](getting-started.md)** — полное пошаговое руководство: распаковка, первый запуск, настройка Python/Java, работа с терминалом, Git, SSH, Kubernetes, PostgreSQL, Kafka, анализ логов и решение проблем.
